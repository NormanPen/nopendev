function DSGVO() {
    return (
        <div className='pt-24    '>
            <article>
                <header>
                    <h1 className='text-2xl mb-20 font-bold'>
                ...
                <section>
                    ...
                    <p className='mb-16'>
                        ...
                        12.10.2022-312225268) verfasst, um Ihnen gemäß der
                ...
                <section>
                    ...
                    <ol className='list-decimal ml-6 mb-8'>
                        ...
                        <li>
                            Vertrag (Artikel 6 Absatz 1 lit. b DSGVO): Um einen
                            Vertrag oder vorvertragliche Verpflichtungen mit
                            Ihnen zu erfüllen, verarbeiten wir Ihre Daten. Wenn
                            wir zum Beispiel einen Kaufvertrag mit Ihnen
                        ...
                        <li>
                            ...
                            unterliegen, verarbeiten wir Ihre Daten. Zum
                            Beispiel sind wir gesetzlich verpflichtet Rechnungen
                            für die Buchhaltung aufzuheben. Diese enthalten in
                        ...
                        <li>
                            ...
                            Verarbeitung personenbezogener Daten vor. Wir müssen
                            zum Beispiel gewisse Daten verarbeiten, um unsere
                            Website sicher und wirtschaftlich effizient
                    ...
                    <p className='mb-8'>
                        ...
                        öffentlichen Interesse und Ausübung öffentlicher Gewalt
                        sowie dem Schutz lebenswichtiger Interessen treten bei
                        uns in der Regel nicht auf. Soweit eine solche
                        Rechtsgrundlage doch einschlägig sein sollte, wird diese
                    ...
                    <ul className='list-disc ml-6 mb-6'>
                        <li>
                            ...
                            personenbezogener Daten (Datenschutzgesetz), kurz
                            DSG.
                        </li>
                        <li>
                ...
                <section>
                    ...
                    <p className='mb-6'>
                        ...
                        die Kontaktdaten der verantwortlichen Person bzw.
                        Stelle:
                    </p>
                    <div className='ml-6'>
                        <adress>
                            Norman Pendzich
                            <br />
                            Horner Weg 205b, 221111 Hamburg, Deutschland
                            <br />
                            E-Mail: normanpendzich@gmail.com
                            <br />
                            Telefon: +49 151 61449132
                            <br />
                            Impressum: https://www.normanpendzich.dev/impressum/
                            <br />
                        </adress>
                    </div>
                </section>
                    ...
                    <ul className='list-disc ml-6 mb-6'>
                        <li className='mt-6'>
                            ...
                            <ul className='list-disc ml-8 mt-4'>
                                ...
                                <li>
                                    die Herkunft der Daten, wenn wir sie nicht
                                    bei Ihnen erhoben haben;
                                </li>
                                <li>
                                    ob Profiling durchgeführt wird, ob also
                                    Daten automatisch ausgewertet werden, um zu
                                    einem persönlichen Profil von Ihnen zu
                                    gelangen.
                                </li>
                            </ul>
                            <li className='pt-4'>
                            ...
                            <li>
                                ...
                                Einschränkung der Verarbeitung, was bedeutet,
                                dass wir die Daten nur mehr speichern dürfen
                                aber nicht weiter verwenden.
                            </li>
                            <li>
                                Sie haben laut Artikel 20 DSGVO das Recht auf
                                Datenübertragbarkeit, was bedeutet, dass wir
                                Ihnen auf Anfrage Ihre Daten in einem gängigen
                                Format zur Verfügung stellen.
                            </li>
                            <li>
                                Sie haben laut Artikel 21 DSGVO ein
                                Widerspruchsrecht, welches nach Durchsetzung
                                eine Änderung der Verarbeitung mit sich bringt.
                                <ul className='list-disc ml-8 mt-4'>
                                    <li>
                                        Wenn die Verarbeitung Ihrer Daten auf
                                        Artikel 6 Abs. 1 lit. e (öffentliches
                                        Interesse, Ausübung öffentlicher Gewalt)
                                        oder Artikel 6 Abs. 1 lit. f
                                        (berechtigtes Interesse) basiert, können
                                        Sie gegen die Verarbeitung Widerspruch
                                        einlegen. Wir prüfen danach so rasch wie
                                        möglich, ob wir diesem Widerspruch
                                        rechtlich nachkommen können.
                                    </li>
                                    <li>
                                        Werden Daten verwendet, um Direktwerbung
                                        zu betreiben, können Sie jederzeit gegen
                                        diese Art der Datenverarbeitung
                                        widersprechen. Wir dürfen Ihre Daten
                                        danach nicht mehr für Direktmarketing
                                        verwenden.
                                    </li>
                                    <li>
                                        Werden Daten verwendet, um Profiling zu
                                        betreiben, können Sie jederzeit gegen
                                        diese Art der Datenverarbeitung
                                        widersprechen. Wir dürfen Ihre Daten
                                        danach nicht mehr für Profiling
                                        verwenden.
                                    </li>
                                </ul>
                                <li className='mt-4'>
                                    Sie haben laut Artikel 22 DSGVO unter
                                    Umständen das Recht, nicht einer
                                    ausschließlich auf einer automatisierten
                                    Verarbeitung (zum Beispiel Profiling)
                                    beruhenden Entscheidung unterworfen zu
                                    werden.
                                </li>
                                <li>
                                    Sie haben laut Artikel 77 DSGVO das Recht
                                    auf Beschwerde. Das heißt, Sie können sich
                                    jederzeit bei der Datenschutzbehörde
                ...
                <section>
                    ...
                    <div className='ml-6'>
                        <adress>
                            Landesbeauftragter für Datenschutz: Prof. Dr.
                            Johannes Caspar
                            <br />
                ...
                <section>
                    ...
                    <p className='mb-6'>
                        ...
                        wie möglich, dass Dritte aus unseren Daten auf
                ...
                <section>
                    ...
                    <div className='ml-6 mb-6'>
                        Kommunikation Zusammenfassung <br />
                        ...
                        (Einwilligung), Art. 6 Abs. 1 lit. b DSGVO (Vertrag),
                        Art. 6 Abs. 1 lit. f DSGVO (Berechtigte Interessen)
                        <br />
                    </div>
                    <p className='mb-6'>
                        Wenn Sie mit uns Kontakt aufnehmen und per Telefon,
                        E-Mail oder Online-Formular kommunizieren, kann es zur
                ...
                <section>
                    ...
                    <p>
                        ...
                        über die von uns bereit gestellten Kommunikationswege
                        den Kontakt zu uns suchen.
                    </p>
                </section>
                <section>
                    <h2 className='text-2xl mb-4 mt-8 font-bold'>Telefon</h2>
                    <p>
                ...
                <section>
                    <h2 className='text-2xl mb-4 mt-8 font-bold'>E-Mail</h2>
                    <p>
                ...
                <section>
                    ...
                    <p className='mb-6'>
                        Wir verwenden für unsere Website den Webhosting-Dienst
                        GitHub Pages. Dienstanbieter ist das amerikanische
                        Unternehmen GitHub Inc., 88 Colin P. Kelly Jr. St.,San
                        Francisco, CA 94107, USA.
                    </p>
                    <p className='mb-6'>
                        GitHub verarbeitet Daten von Ihnen u.a. auch in den USA.
                    ...
                    <p className='mb-6'>
                        ...
                        GitHub sogenannte Standardvertragsklauseln (= Art. 46.
